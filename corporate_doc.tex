...
\definecolor{dark-grey}{RGB}{127,120,127}
...
\newcommand{\filigranne}{
\begin{textblock*}{50mm}(6mm,170mm)  % filigrane
\rotatebox[origin=c]{90} {
{
\color{dark-grey}
\small
\emph{Secret document -- Burn after reading}
}
}
\end{textblock*}
